...
void information(string &a, int &b, int m[5], int &d) {
    ...
    cin.ignore();   // Ignore the newline before the next getline()
}

void display(string a, int b, int d) {
    cout << "\nName of the student is: " << a << endl;
    cout << "Age of the student is: " << b << endl;
    cout << "Percentage of the student is: " << d << "%" << endl;
    cout << "-----------------------------" << endl;
}
...
int main() {
    ...
    cout << "Enter number of students: " << endl;
    cin >> n;
    cin.ignore();   // Ignore newline after entering n
    ...
    for(int i = 1; i <= n; i++) {
        ...
        information(name, age, marks, perc);
        display(name, age, perc);
    }
